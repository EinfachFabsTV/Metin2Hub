...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string[]> Texts = new(StringComparer.Ordinal)
    {
        ...
        ["char.form.grotte"] = ["Grotte – levelt für Meley (Name rot)", "Cave – levelling for Meley (name in red)", "Mağara – Meley için seviye atlıyor (ad kırmızı)", "Grotta – sale di livello per Meley (nome in rosso)"],
        ["char.form.balathor"] = ["Balathor-Char", "Balathor character", "Balathor karakteri", "Personaggio Balathor"],
        ["char.form.serpent"] = ["Serpent-Segment-Char", "Serpent Segment character", "Serpent Segment karakteri", "Personaggio Serpent Segment"],
